...
skin_df[skin_df['dx']=='nv']['sex'].value_counts().plot(kind='bar', ax=ax2) 
#REPLACE skin_df with skin = 
...
skin['sex'].value_counts().plot(kind='bar', ax=ax2)
ax2.set_ylabel('Count', size=15)
ax2.set_title('Sex distribution among NV');
...
#PLot fractional correct classifications
